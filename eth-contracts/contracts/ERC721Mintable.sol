...
import "../node_modules/@openzeppelin/contracts/utils/Strings.sol";
 ...
 contract  Ownable {
    ...
    // as per pragma 0.8.0, making class abstract with no visibility specified in constructor
    constructor ()  {
        _owner = msg.sender;
...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(getOwner() == msg.sender || isApprovedForAll(ownerOf(tokenId), getOwner()));
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal virtual {
        ...
        require(to != address(0), "invalid receiving address");
        // TODO: clear approval
...
contract ERC721Metadata is ERC721Enumerable, usingProvable {
    ...
    function setTokenURI(uint256 tokenId) internal {
        ...
        string memory computedURI = strConcat(_baseTokenURI, tokenString);

        _tokenURIs[tokenId] = computedURI;
    }
...
contract casaToken is ERC721Metadata {

    constructor() ERC721Metadata("casaToken", "CST", "https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/"){
